...
{#fun unsafe rp_DpinSetDirection { `DigitalPin' , `PinDirection' } -> `RpError' #}
...
{#fun unsafe rp_DpinGetDirection { `DigitalPin' , alloca- `PinDirection' peekEnum* } -> `RpError' #}
...
{#fun unsafe rp_ApinGetValueRaw  { `AnalogPin' ,  alloca- `Integer' peekInt* } -> `RpError' #}
...
{#fun unsafe rp_ApinSetValue { `AnalogPin' ,  `CFloat'} -> `RpError' #}
...
{#fun unsafe rp_ApinSetValueRaw { `AnalogPin' , `Int'} -> `RpError' #}
...
{#fun unsafe rp_ApinGetRange  { `AnalogPin' ,  alloca- `CFloat' peek* ,  alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetDecimation {`Decimation'} -> `RpError' #}
...
{#fun unsafe rp_AcqGetDecimation  {alloca- `Decimation' peekEnum*} -> `RpError' #}
...
{#fun unsafe rp_AcqGetDecimationFactor {alloca- `Integer' peekInt*} -> `RpError' #}
...
{#fun unsafe rp_AcqSetSamplingRate  {`SamplingRate'} -> `RpError' #}
...
{#fun unsafe rp_AcqGetSamplingRate { alloca- `SamplingRate' peekEnum* } -> `RpError' #}
...
{#fun unsafe rp_AcqGetSamplingRateHz  { alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetAveraging   {`Bool'} -> `RpError' #}
...
{#fun unsafe rp_AcqGetAveraging   { alloca- `Bool' peekBool*} -> `RpError' #}
...
{#fun unsafe rp_AcqSetTriggerSrc {`TriggerSource'} -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerSrc {alloca- `TriggerSource' peekEnum*} -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerState {alloca- `TriggerState' peekEnum*} -> `RpError' #}
...
{#fun unsafe rp_AcqSetTriggerDelay  { fromIntegral `Integer' } -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerDelay { alloca- `Integer' peekInt* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetTriggerDelayNs { fromIntegral `Integer'  } -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerDelayNs { alloca- `Integer' peekInt* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetTriggerLevel { `CFloat' } -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerLevel { alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetTriggerHyst { `CFloat' } -> `RpError' #}
...
{#fun unsafe rp_AcqGetTriggerHyst { alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_AcqSetGain { `Channel' , `PinState' } -> `RpError' #}
...
{#fun unsafe rp_AcqGetGain { `Channel' , alloca- `PinState' peekEnum* } -> `RpError' #}
...
{#fun unsafe rp_AcqGetGainV { `Channel' , alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_AcqGetWritePointer { alloca- `Integer' peekInt* } -> `RpError' #}
...
{#fun unsafe rp_AcqGetWritePointerAtTrig { alloca- `Integer' peekInt* } -> `RpError' #}
...
{#fun unsafe rp_AcqGetNormalizedDataPos { fromIntegral `Integer' } ->  `Integer' fromIntegral #}
...
getAckDataRaw = mapr3 ( errorMap ft2) $ getPosSizeBufferHelper {#call unsafe rp_AcqGetDataRaw#}

-- | get  ADC data Voltage from channel passing position and size
getAckDataV :: Channel -> Int -> Int -> RpMonad [CFloat]
getAckDataV = mapr3 ( errorMap ft2) $ getPosSizeBufferHelper {#call unsafe rp_AcqGetDataV#}
...
getAckOldestDataRaw = mapr2 ( errorMap ft2) $ getSizeBufferHelper {#call unsafe rp_AcqGetOldestDataRaw#}

-- | Returns the ADC buffer in raw units from the latest
-- First parameter is maximal length of returned data (how large buffer to allocate)
getAckLatestDataRaw :: Int -> Channel ->  RpMonad [CShort]
getAckLatestDataRaw = mapr2 ( errorMap ft2) $ getSizeBufferHelper {#call unsafe rp_AcqGetLatestDataRaw#}
...
-- {#fun unsafe rp_GenGetAmp {`Channel' , alloca- `CFloat' peek* } -> `RpError' #}
...
{#fun unsafe rp_GenPhase {`Channel' , `CFloat' } -> `RpError' #}


-- | Sets channel signal phase. This shifts the signal in time.
generatorWaveForm ::   Channel -> Waveform -> RpMonad ()
generatorWaveForm = mapr2 ( errorMap ft1) rp_GenWaveform
{#fun unsafe rp_GenWaveform  {`Channel' , `Waveform' } -> `RpError' #}
...
generatorArbWaveForm = mapr2 ( errorMap ft1) gawf
    where 
            ...
            gawf c xs = (toEnum . fromIntegral) <$>
                setBufferHelper ({#call unsafe rp_GenArbWaveform #}
...
{#fun unsafe rp_GenBurstCount {`Channel' , fromInteger `Integer' } -> `RpError' #}
...
{#fun unsafe rp_GenBurstRepetitions {`Channel' , fromInteger `Integer' } -> `RpError' #}
...
{#fun unsafe rp_GenBurstPeriod {`Channel' , fromInteger `Integer' } -> `RpError' #}

-- | Sets trigger source.
generatorTriggerSource ::   Channel -> TriggerSource -> RpMonad ()
generatorTriggerSource = mapr2 ( errorMap ft1) rp_GenTriggerSource
{#fun unsafe rp_GenTriggerSource {`Channel' , `TriggerSource' } -> `RpError' #}
